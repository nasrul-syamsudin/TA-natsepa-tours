...
$isi.= "<img src='../images/ntlogo.png' style='float: left; height: 90px'>";

  $isi.= "<div style='margin-left: 20px'>";
    $isi.= "<div style='font-size:18px'>Laporan Pemesanan ".$status."</div>";
    $isi.= "<div style='font-size:20px'> PO. Natsepa</div>";
    $isi.= "<div style='font-size:18px'> Alamat: JL. Natsepa No. 84 Ambon</div>";
